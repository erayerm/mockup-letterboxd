        ...
        <div className="container pb-[30px]">
            <div className="border border-[rgba(136,153,170,0.1)] flex w-full justify-center items-center">
                <div className="flex justify-center gap-5 w-full ">
                    {profileNav.map((item, index) => <Link key={index} href={item.link} className={"h-full py-3 text-[15px] " + (index == 0 ? "border_container text-secondary-white" : "hover:text-hover-blue")}>{item.name}</Link>)}
                </div>
