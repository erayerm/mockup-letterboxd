    ...
    return (
        <div className="flex justify-between items-center py-[30px]">
            <div className="flex items-center gap-4">
                <img src={userData.photo ? userData.photo : "https://cdn.pixabay.com/photo/2015/10/05/22/37/blank-profile-picture-973460_960_720.png"} className="size-[100px] rounded-full outline outline-1 hover:outline-2 outline-offset-[-1px] hover:outline-offset-[-2px] outline-[rgba(216,224,232,0.5)]" />
                <div className="flex flex-col gap-1">
                    <div className="flex items-center gap-4 font-bold">
                        <div className="relative group">
                            <h1 className="text-2xl group text-secondary-white">{userData.givenName ? userData.givenName + " " + userData.familyName : userData.username}</h1>
