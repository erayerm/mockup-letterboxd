...
function FilmActivityCard() {
  ...
  const handleMouseLeaveShare = () =>
    (shareRef.current = setTimeout(() => setIsShareOpen(false), 1000));
      ...
      <ul className="space-y-[1px] film-activity-card-ul">
        <li>
          <div className="flex justify-around">
            <div
              onMouseEnter={handleWatchRemove}
              onMouseLeave={handleWatchRemove}
              className="basis-[33%] text-center flex flex-col"
            >
              <button className="text-[32px]" onClick={toggleIsWatched}>
                <FontAwesomeIcon
            ...
            <div
              onMouseEnter={handleLikeRemove}
              onMouseLeave={handleLikeRemove}
              className="basis-[33%] text-center flex flex-col"
            >
              <button className="text-[32px]" onClick={toggleIsLiked}>
                <FontAwesomeIcon
            ...
            <div
              onMouseEnter={handleWatchlistRemove}
              onMouseLeave={handleWatchlistRemove}
              className="basis-[33%] text-center flex flex-col"
            >
              <button className="text-[32px]" onClick={toggleIsWatchlisted}>
                <FontAwesomeIcon
                  className={filmState.isWatchlisted ? "text-[#41BCF4]" : ""}
                  icon={faStopwatch}
                />
              </button>
              <p>
        ...
        <li>
          <Link href={"/" + session?.user.username + basePath + "activity"}>
            Show your activity
          </Link>
        </li>
        <li>
          <button onClick={() => true /* TODO:modal for review */}>
            Review or log{/* TODO:again? */}...
          </button>
        </li>
        <li>
          <button onClick={() => true /* TODO:modal for lists */}>
            Add to lists...
          </button>
        </li>
        <li>
          <p>
            ...
            <Link
              href={"#"}
              className="mx-1 text-[12px] bg-blue-500 px-[7px] py-[1px] rounded-sm text-[#fff]"
            >
              PATRON
            </Link>{" "}
            to change images
            ...
            <div className="flex items-center justify-center gap-2">
              <div className="flex max-w-[60%]">
                ...
                <button
                  ...
                  className="border border-[#2D3440] px-1"
                >
              ...
              <a
                target="_blank"
                href={
                  "https://twitter.com/intent/tweet?text=film: " +
                  slugifiedTitle +
                  " link: letterboxd.com" +
                  pathname
                }
              ...
              <a
                target="_blank"
                href={"https://twitter.com/intent/tweet?text=" + slugifiedTitle}
              >
                <FontAwesomeIcon className="text-[18px]" icon={faFacebook} />
              </a>
            </div>
          ) : (
            <p>Share</p>
